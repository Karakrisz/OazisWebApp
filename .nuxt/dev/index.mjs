...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHost, getRequestProtocol, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, setHeader, getHeader, getQuery as getQuery$1, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withBase, withoutTrailingSlash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/@unhead/ssr/dist/index.mjs';
...
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/consola/dist/index.mjs';
import devalue from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/unctx/dist/index.mjs';
import { toValue, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/vue/index.mjs';
...
import { isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/pathe/dist/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _tILkBPZ601 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Applications/XAMPP/xamppfiles/htdocs/OazisWebApp";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _q50L0SgIJj = (nitroApp) => {
...
const _YrNHIU = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _1v9LCD = defineEventHandler(async (e) => {
...
const _lazy_oPdpg7 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_oPdpg7, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _1ShRdf, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _YrNHIU, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _1v9LCD, lazy: false, middleware: false, method: undefined },
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Ide kell a szöveg, függönyoket varnak budapesten"},{"name":"format-detection","content":"telephone=no"},{"hid":"robots","name":"robots","content":"index, follow"},{"http-equiv":"Content-Security-Policy","content":"\n            default-src 'self' https: data:;\n            img-src 'self' https: http: data:;\n            font-src 'self' https: data:;\n            style-src 'self' https: 'unsafe-inline';\n            script-src 'self' https: 'unsafe-inline' 'unsafe-eval';\n            connect-src 'self' https: http: http://127.0.0.1:8000/json-posts;\n          "}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap"}],"style":[],"script":[{"type":"application/ld+json","innerHTML":"{\"@context\":\"https://schema.org\",\"@type\":\"WebSite\",\"name\":\"Függöny Oázis\",\"url\":\"https://www.fuggonyoazis.hu\",\"potentialAction\":{\"@type\":\"SearchAction\",\"target\":\"https://www.fuggonyoazis.hu/?s={search_term_string}\",\"query-input\":\"required name=search_term_string\"}}"}],"noscript":[],"title":"Függöny Oázis","htmlAttrs":{"lang":"hu"}};
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/OazisWebApp/.nuxt/dist/server/server.mjs').then((r) => r.default || r);

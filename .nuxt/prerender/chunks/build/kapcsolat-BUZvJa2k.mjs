...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "supage-content position-relative" }, _attrs))}><h2 class="supage-content__h2">KAPCSOLAT</h2><p>felt\xF6lt\xE9s alatt...</p></div>`);
    };
  }
};
...
//# sourceMappingURL=kapcsolat-BUZvJa2k.mjs.map

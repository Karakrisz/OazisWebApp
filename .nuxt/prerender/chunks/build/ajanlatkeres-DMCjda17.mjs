...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      title: "Aj\xE1nlatk\xE9r\xE9s"
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "kapcsolat" }, _attrs))}><h2>Aj\xE1nlatk\xE9r\xE9s</h2>`);
...
//# sourceMappingURL=ajanlatkeres-DMCjda17.mjs.map
